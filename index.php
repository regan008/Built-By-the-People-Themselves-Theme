...
<?php $featuredPeople = get_records('Item', array(
  ...
  <div class="large-6 columns" >
  <div class="row">
    <div id="featured-question" class="featured large-6 columns"  data-equalizer-watch style="background-repeat: no-repeat; background-image:url('<?php echo file_display_url($featuredPersonFile, 'fullsize'); ?>')">
      <h3 class="feat-exhibit-title text-center">
